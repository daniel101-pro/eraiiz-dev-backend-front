      ...
      <div className="min-h-screen bg-white mt-16">
        ...
        <div className="w-full max-w-4xl mx-auto p-4">
          <div className="flex items-center bg-gray-100 border border-gray-300 rounded-full px-4 py-2 shadow-sm">
            ...
            />
            <button className="ml-2 p-1.5 rounded-full bg-white text-gray-600 hover:bg-gray-200 transition">
              <FilterIcon />
            </button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto p-4">
          {!selectedCategory ? (
            <>
              <h2 className="text-lg font-semibold text-gray-700 mb-4">All categories on Eraiz</h2>
