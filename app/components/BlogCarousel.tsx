    ...
    <div className="flex flex-col lg:flex-row items-center justify-between mt-8 px-6 lg:px-16">
      ...
      <div className="lg:w-1/3">
        <Card className="p-6 bg-white rounded-2xl shadow-lg transition-all hover:shadow-xl">
          ...
          <p className="text-gray-600">Recycling is more than just a trend— in this blog, we delve into the innovative ways industries and individuals are transforming waste into valuable materials.</p>
